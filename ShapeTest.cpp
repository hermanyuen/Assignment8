...
TEST(drawUnique, Shape)
{
	...
	//Triangle(Point(11.1, 22.2), Point(33.3, 44.4), Point(55.5, 66.6), canvas);
	//auto test = std::make_unique<Triangle>(Point(11.1, 22.2), Point(33.3, 44.4), Point(55.5, 66.6), canvas);
	...
	//CHECK_EQUAL("draw triangle: 11.1,22.2,33.3,44.4,55.5,66.6", canvas.str());
